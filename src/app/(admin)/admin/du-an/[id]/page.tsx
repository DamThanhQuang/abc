...
export const metadata: Metadata = { title: "Sửa dự án | Admin" };
...
export default async function AdminEditProjectPage({
  ...
  async function handleUpdate(formData: FormData) {
    ...
    const result = await updateProject(id, projectInputFromForm(formData));
    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="font-heading font-bold text-[22px] text-content-heading">Sửa dự án</h1>
            <p className="font-sans text-[13px] text-content-muted">{project.name}</p>
          </div>
