...
export default function AdminYeuCauPage() {
                  ...
                  <tr key={c.id} className={`border-b border-border-ui last:border-0 ${i % 2 === 1 ? "bg-surface-card/30" : ""}`}>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        <button type="button" className="rounded-[6px] border border-border-ui px-3 py-1.5 font-sans text-[12px] text-content-body hover:bg-surface-card transition-colors whitespace-nowrap">
                          Xem chi tiết
                        </button>
                        {c.status !== "resolved" && (
                          <button type="button" className="rounded-[6px] border border-green-200 px-3 py-1.5 font-sans text-[12px] text-green-600 hover:bg-green-50 transition-colors whitespace-nowrap">
                            Đã xử lý
                          </button>
                        )}
                      </div>
