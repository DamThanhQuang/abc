...
export const metadata: Metadata = {
  title: "Liên hệ",
  description: "Liên hệ Ánh Sáng Toàn Cầu qua Zalo hoặc để lại thông tin để được tư vấn về thiết bị và giải pháp trạm xăng dầu.",
...
export default async function LienHePage({ searchParams }: Props) {
  ...
  return (
    <>
      <PageHero
        title="Liên hệ"
        subtitle="Nhắn Zalo hoặc để lại thông tin, chúng tôi sẽ liên hệ tư vấn về thiết bị và giải pháp trạm xăng dầu"
      ...
      <main className="mx-auto max-w-content px-4 py-10 sm:px-6 lg:px-16 lg:py-16">
        <div className="mx-auto grid max-w-6xl items-stretch gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          >
            <div className="flex h-full flex-col">
              ...
              <div className="flex flex-1 flex-col p-6 sm:p-8 lg:p-10">
                ...
                {/* Đẩy giờ làm việc xuống đáy thẻ khi thẻ được kéo cao bằng form bên cạnh. */}
                <div aria-hidden="true" className="min-h-5 flex-1" />
                <div className="flex items-start gap-3 border-t border-border-ui pt-5 text-content-muted">
          ...
          >
            ...
            <p className="mb-6 mt-3 font-sans text-[14px] leading-6 text-content-body sm:text-[15px]">
              Điền thông tin bên dưới, bộ phận tư vấn sẽ gọi lại hoặc gửi email cho bạn.
            </p>
        ...
        <section
          ...
          className="mx-auto mt-8 max-w-6xl rounded-[24px] border border-border-ui bg-surface-card p-6 sm:p-8 lg:p-10"
        >
